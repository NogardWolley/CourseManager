...
public class SeminarGradeDetailOrignalVO {
	String seminarName;
	public SeminarGradeDetailOrignalVO(String seminarName, String groupName, String leaderName, Integer presentationGrade,
